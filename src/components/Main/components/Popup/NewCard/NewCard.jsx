...
export default function NewCard(props) {
  ...
  const handleValidation = (e) => {
    ...
    if (!value) {
      ...
      value.length > INPUT_CARD_NAME_MAX_LENGTH &&
      input.type !== "url"
    ) {
      ...
      <fieldset className="popup__content">
        <label className="popup__field popup__field_top">
          <input
            ...
            className={`popup__input ${
              errors.cardTitle ? config.inputErrorClass : ""
            }`}
            placeholder="Titulo"
            id="title-input"
            {...register("cardTitle", {
              ...
              minLength: {
                value: INPUT_CARD_NAME_MIN_LENGTH,
                message: errorMessages.minLength,
              },
              maxLength: {
                value: INPUT_CARD_NAME_MAX_LENGTH,
          ...
          />
          {touchedFields.cardTitle && errors.cardTitle && (
            <span className={`popup__input-error ${config.errorClass}`}>
        ...
        <label className="popup__field">
          <input
            type="url"
            className={`popup__input ${
              errors.cardLink ? config.inputErrorClass : ""
            }`}
            ...
            onBlur={handleValidation}
          />
          {touchedFields.cardLink && errors.cardLink && (
            <span className={`popup__input-error ${config.errorClass}`}>
        ...
        <button
          ...
          className={`popup__button ${
            disabled ? config.inactiveButtonClass : ""
          }`}
          disabled={disabled}
        >
