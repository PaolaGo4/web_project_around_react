...
function Main(props) {
  ...
  const newCardPopup = {
    title: "Nuevo lugar",
    children: <NewCard validationConfig={validationConfig} />,
  };
  const editProfolePopup = {
    title: "Nuevo lugar",
    children: <EditProfile validationConfig={validationConfig} />,
  };
  const editAvatarPopup = {
    title: "Nuevo avatar",
    children: <EditAvatar validationConfig={validationConfig} />,
  };
  ...
  function handleTrashClick(card) {
    onOpenPopup({
      title: "¿Estás seguro?",
      children: <RemoveCard onCardDelete={onCardDelete} card={card} />,
    });
  }
